//package com.vaadin.tutorial.crm.ui.views.timeRangePicker;
//
...
//import com.vaadin.tutorial.crm.ui.views.dateRangePicker.DateRangePickerOverlay;
//import com.vaadin.tutorial.crm.ui.views.dateRangePicker.DateRangePickerStyles;
//import com.vaadin.tutorial.crm.ui.views.dateRangePicker.DateRangeValueChangeEvent;
...
//public class TimeRangePicker<D extends DateRange> extends Composite<VerticalLayout> implements
//        FlexComponent<VerticalLayout>,
//        HasItems<D>,
//        DateRangeActions<D, TimeRangePicker<D>>,
...
//
//    public TimeRangePicker(final DateRangeModel<D> initialModel) {
//        this(initialModel, new ArrayList<>());
//    }
//
//    public TimeRangePicker(final DateRangeModel<D> initialModel, final D[] items) {
//        this(initialModel, new ArrayList<>(Arrays.asList(items)));
//    }
//
//    public TimeRangePicker(final DateRangeModel<D> initialModel, final Collection<D> items) {
...
//    }
//
//    public TimeRangePicker(final Supplier<DateRangeModel<D>> initialModelSupplier) {
//        this(initialModelSupplier.get());
//    }
//
//    public TimeRangePicker(final Supplier<DateRangeModel<D>> initialModelSupplier, final D[] items) {
//        this(initialModelSupplier.get(), items);
//    }
//
//    public TimeRangePicker(final Supplier<DateRangeModel<D>> initialModelSupplier, final Collection<D> items) {
//        this(initialModelSupplier.get(), items);
//    }
//
//    // -- Initializers --
//
//    public TimeRangePicker<D> withCloseOnOutsideClick(final boolean closeOnOutsideClick) {
...
//    }
//
//    public TimeRangePicker<D> withDatePickerI18n(final DatePickerI18n datePickerI18n) {
...
//    }
//
//    public TimeRangePicker<D> withFormatLocale(final Locale locale) {
...
//    }
//
//    public TimeRangePicker<D> withDateRangeLocalizerFunction(final ItemLabelGenerator<D> dateRangeLocalizerFunction) {
...
//
//    /**
//     * Shortcut for {@link TimeRangePicker#setStartLabel(String)}
//     *
//     * @param label
//     * @return
//     */
//    public TimeRangePicker<D> withStartLabel(final String label) {
//        this.setStartLabel(label);
//        return this;
//    }
//
//    /**
//     * Shortcut for {@link TimeRangePicker#setEndLabel(String)}
//     *
//     * @param label
//     * @return
//     */
//    public TimeRangePicker<D> withEndLabel(final String label) {
//        this.setEndLabel(label);
//        return this;
//    }
//
//    /**
//     * Shortcut for {@link TimeRangePicker#setDateRangeOptionsLabel(String)}
//     *
//     * @param label
//     * @return
//     */
//    public TimeRangePicker<D> withDateRangeOptionsLabel(final String label) {
...
//     * set by {@link TimeRangePicker#setModel(DateRangeModel)}
//     *
//     * @param range
//     */
...
//
//    @Override
//    public TimeRangePicker<D> setStart(final LocalDate start) {
...
//
//    @Override
//    public TimeRangePicker<D> setEnd(final LocalDate end) {
...
//
//    @Override
//    public TimeRangePicker<D> setDateRange(final D dateRange) {
...
//     * Use {@link TimeRangePicker#setValue(DateRangeModel)} instead.
//     *
